...
export function InsightsPage() {
  ...
  return (
    <div className="space-y-5">
      <Card className="motion-fade-up motion-lift p-6 md:p-8">
        ...
        <>
          <div className="grid gap-5 md:grid-cols-3">
            {[
              ...
              <Card key={label} className="motion-fade-up motion-lift p-6" style={staggerStyle(index + 1)}>
          ...
          <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
            <Card className="motion-fade-up motion-lift p-6" style={staggerStyle(4)}>
            ...
            <Card className="motion-fade-up motion-lift p-6" style={staggerStyle(5)}>
              ...
              <div className="mt-6 flex items-center justify-between gap-4 rounded-[24px] bg-[rgb(var(--bg-soft))] p-5">
                <div>
                  <p className="text-4xl font-bold"><AnimatedNumber value={analytics?.streak?.current_streak || 0} /></p>
